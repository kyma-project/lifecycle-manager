...
var _ = BeforeSuite(func() {
	...
	err = (&kyma.Reconciler{
		...
		OCIRegistryHost: "europe-west3-docker.pkg.dev/sap-kyma-jellyfish-dev/template-operator", // conforms to the url defined in `v1beta2_template_operator_current_ocm.yaml`
