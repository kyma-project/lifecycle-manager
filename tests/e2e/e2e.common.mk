...
MODULE_DEPLOYMENT_OLDER_VERSION   := template-operator-v$(MODULE_VERSION_OLDER_BASE_MAJOR)-controller-manager
MODULE_NEWER_VERSION              := $(MODULE_VERSION_NEWER_BASE)$(E2E_SUFFIX)
MODULE_DEPLOYMENT_NEWER_VERSION   := template-operator-v$(MODULE_VERSION_NEWER_BASE_MAJOR)-controller-manager
