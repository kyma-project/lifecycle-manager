...
module-setup:
	...
	$(SCRIPTS_DIR)/deploy_moduletemplate_e2e.sh --module-name $(MODULE_NAME) --version $(MODULE_MANDATORY_NEWER_VERSION) --deployment-name $(MODULE_DEPLOYMENT_NEWER_VERSION) --deployable-version $(MODULE_DEPLOYABLE_VERSION) --mandatory
