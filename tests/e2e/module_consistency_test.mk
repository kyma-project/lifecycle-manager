...
test-run: log-tool-versions
	...
	@echo "::group::E2E test: Module Keep Consistent After Deploy"
	@export PATH=$(LOCALBIN):$$PATH
	@pushd $(E2E_TESTS_DIR) > /dev/null
	set +e; $(GO) test -timeout 20m -ginkgo.v -ginkgo.focus "Module Keep Consistent After Deploy"; status=$$?; set -e
	@popd > /dev/null
	@echo "::endgroup::"
	exit $${status}
