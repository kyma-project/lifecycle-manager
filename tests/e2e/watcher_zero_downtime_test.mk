...
HELM_VALUES_OVERLAY := $(dir $(abspath $(lastword $(MAKEFILE_LIST))))helm-values/watcher_zero_downtime.yaml
...
klm-patch: kustomize-install
	...
	kustomize edit add patch --kind Certificate --group cert-manager.io --version v1 --name watcher-serving --patch \
