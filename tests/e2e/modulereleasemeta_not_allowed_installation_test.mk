...
test-run: log-tool-versions
	...
	@echo "::group::E2E test: ModuleReleaseMeta Not Allowed Installation"
	@export PATH=$(LOCALBIN):$$PATH
	@pushd $(E2E_TESTS_DIR) > /dev/null
	set +e; $(GO) test -timeout 20m -ginkgo.v -ginkgo.focus "ModuleReleaseMeta Not Allowed Installation"; status=$$?; set -e
	@popd > /dev/null
	@echo "::endgroup::"
	exit $${status}
