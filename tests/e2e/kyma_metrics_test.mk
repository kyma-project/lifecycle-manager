...
HELM_VALUES_OVERLAY := $(dir $(abspath $(lastword $(MAKEFILE_LIST))))helm-values/kyma_metrics.yaml
...
test-run: log-tool-versions
	...
	@echo "::group::E2E test: Manage Module Metrics"
	@export PATH=$(LOCALBIN):$$PATH
	@pushd $(E2E_TESTS_DIR) > /dev/null
	set +e; $(GO) test -timeout 20m -ginkgo.v -ginkgo.focus "Manage Module Metrics"; status=$$?; set -e
	@popd > /dev/null
	@echo "::endgroup::"
	exit $${status}
