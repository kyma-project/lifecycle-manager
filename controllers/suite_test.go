...
var _ = BeforeSuite(func() {
	...
	remoteCrds, err := ParseRemoteCRDs([]string{
		"https://raw.githubusercontent.com/jakobmoellersap/manifest-operator/kmm-migrate-declarative-v2/config/crd/bases/operator.kyma-project.io_manifests.yaml", //nolint:lll
	})
