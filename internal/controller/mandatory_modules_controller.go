...
func (r *MandatoryModulesReconciler) deleteRemoteClientCache(ctx context.Context, kyma *v1beta2.Kyma) {
	logger := logf.FromContext(ctx)
...
func (r *MandatoryModulesReconciler) getSyncedContext(ctx context.Context, kyma *v1beta2.Kyma) (context.Context,
	error) {
...
func (r *MandatoryModulesReconciler) reconcile(ctx context.Context, kyma *v1beta2.Kyma) (ctrl.Result, error) {
...
func (r *MandatoryModulesReconciler) syncCrdsAndUpdateKymaAnnotations(ctx context.Context, kyma *v1beta2.Kyma) (bool,
	error) {
...
func (r *MandatoryModulesReconciler) deleteRemoteKyma(ctx context.Context, kyma *v1beta2.Kyma) error {
...
func (r *MandatoryModulesReconciler) requeueWithError(ctx context.Context, kyma *v1beta2.Kyma, err error) (ctrl.Result,
	error) {
	return ctrl.Result{Requeue: true}, r.updateStatusWithError(ctx, kyma, err)
}

func (r *MandatoryModulesReconciler) enqueueWarningEvent(kyma *v1beta2.Kyma, reason EventReasonError, err error) {
	r.Event(kyma, "Warning", string(reason), err.Error())
}

func (r *MandatoryModulesReconciler) enqueueNormalEvent(kyma *v1beta2.Kyma, reason EventReasonInfo, message string) {
	r.Event(kyma, "Normal", string(reason), message)
}

func (r *MandatoryModulesReconciler) fetchRemoteKyma(ctx context.Context,
	controlPlaneKyma *v1beta2.Kyma) (*v1beta2.Kyma, error) {
	syncContext, err := remote.SyncContextFromContext(ctx)
	if err != nil {
...
func (r *MandatoryModulesReconciler) syncStatusToRemote(ctx context.Context, controlPlaneKyma *v1beta2.Kyma) error {
...
func (r *MandatoryModulesReconciler) replaceSpecFromRemote(
...
func (r *MandatoryModulesReconciler) processKymaState(ctx context.Context, kyma *v1beta2.Kyma) (ctrl.Result, error) {
...
func (r *MandatoryModulesReconciler) handleInitialState(ctx context.Context, kyma *v1beta2.Kyma) (ctrl.Result, error) {
...
func (r *MandatoryModulesReconciler) handleProcessingState(ctx context.Context, kyma *v1beta2.Kyma) (ctrl.Result,
	error) {
	logger := logf.FromContext(ctx)
...
func (r *MandatoryModulesReconciler) handleDeletingState(ctx context.Context, kyma *v1beta2.Kyma) (ctrl.Result, error) {
	logger := logf.FromContext(ctx).V(log.InfoLevel)
...
func (r *MandatoryModulesReconciler) removeAllFinalizers(kyma *v1beta2.Kyma) {
	for _, finalizer := range kyma.Finalizers {
		controllerutil.RemoveFinalizer(kyma, finalizer)
	}
}

func (r *MandatoryModulesReconciler) updateKyma(ctx context.Context, kyma *v1beta2.Kyma) error {
	if err := r.Update(ctx, kyma); err != nil {
...
func (r *MandatoryModulesReconciler) reconcileManifests(ctx context.Context, kyma *v1beta2.Kyma) error {
...
func (r *MandatoryModulesReconciler) syncModuleCatalog(ctx context.Context, kyma *v1beta2.Kyma) error {
...
func (r *MandatoryModulesReconciler) updateStatus(ctx context.Context, kyma *v1beta2.Kyma,
...
func (r *MandatoryModulesReconciler) updateStatusWithError(ctx context.Context, kyma *v1beta2.Kyma, err error) error {
...
func (r *MandatoryModulesReconciler) GenerateModulesFromTemplate(ctx context.Context,
	kyma *v1beta2.Kyma) (common.Modules, error) {
...
func (r *MandatoryModulesReconciler) DeleteNoLongerExistingModules(ctx context.Context, kyma *v1beta2.Kyma) error {
...
func (r *MandatoryModulesReconciler) deleteManifest(ctx context.Context,
	trackedManifest *v1beta2.TrackingObject) error {
...
func (r *MandatoryModulesReconciler) UpdateMetrics(ctx context.Context, kyma *v1beta2.Kyma) {
...
func (r *MandatoryModulesReconciler) WatcherEnabled(kyma *v1beta2.Kyma) bool {
	return r.SyncKymaEnabled(kyma) && r.SKRWebhookManager != nil
}

func (r *MandatoryModulesReconciler) IsInKcp() bool {
	return r.InKCPMode
}

func (r *MandatoryModulesReconciler) SyncKymaEnabled(kyma *v1beta2.Kyma) bool {
	if !r.InKCPMode {
		return false
	}
...
func (r *MandatoryModulesReconciler) IsKymaManaged() bool {
