...
func TestGetConfigFile(t *testing.T) {
	t.Run("should fetch config file successfully", func(t *testing.T) {
		...
		repo, err := oci.NewRepository(&mockKeyChainLookup{}, "europe-docker.pkg.dev/kyma-project/prod", true)
		...
		assert.Equal(t, "europe-docker.pkg.dev/kyma-project/prod/component-descriptors/test-name:test-version", mcc.configRefArg)
