...
replace github.com/kyma-project/module-manager v0.0.0-20230105142740-3cfa8d2c94ca => github.com/jakobmoellersap/manifest-operator v0.0.0-20230111100215-65dc51fff8e4
