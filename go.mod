...
replace github.com/kyma-project/module-manager v0.0.0-20221207164018-ddf69229acb6 => github.com/jakobmoellersap/manifest-operator v0.0.0-20230110105325-e8f69950bee9
