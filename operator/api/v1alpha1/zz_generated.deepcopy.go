...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModuleTemplateWebhookSettings) DeepCopyInto(out *ModuleTemplateWebhookSettings) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModuleTemplateWebhookSettings.
func (in *ModuleTemplateWebhookSettings) DeepCopy() *ModuleTemplateWebhookSettings {
	if in == nil {
		return nil
	}
	out := new(ModuleTemplateWebhookSettings)
	in.DeepCopyInto(out)
	return out
}
