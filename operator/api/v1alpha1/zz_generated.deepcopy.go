...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in KymaSettings) DeepCopyInto(out *KymaSettings) {
	{
		in := &in
		*out = make(KymaSettings, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KymaSettings.
func (in KymaSettings) DeepCopy() KymaSettings {
	if in == nil {
		return nil
	}
	out := new(KymaSettings)
	in.DeepCopyInto(out)
	return *out
}
