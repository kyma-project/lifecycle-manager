...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in CustomStates) DeepCopyInto(out *CustomStates) {
	{
		in := &in
		*out = make(CustomStates, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomStates.
func (in CustomStates) DeepCopy() CustomStates {
	if in == nil {
		return nil
	}
	out := new(CustomStates)
	in.DeepCopyInto(out)
	return *out
}
