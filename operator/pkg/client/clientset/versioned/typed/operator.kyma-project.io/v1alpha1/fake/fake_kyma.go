...
func (c *FakeKymas) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Kyma, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(kymasResource, c.ns, name), &v1alpha1.Kyma{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Kyma), err
}
...
func (c *FakeKymas) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KymaList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(kymasResource, kymasKind, c.ns, opts), &v1alpha1.KymaList{})
	...
	list := &v1alpha1.KymaList{ListMeta: obj.(*v1alpha1.KymaList).ListMeta}
	for _, item := range obj.(*v1alpha1.KymaList).Items {
...
func (c *FakeKymas) Create(ctx context.Context, kyma *v1alpha1.Kyma, opts v1.CreateOptions) (result *v1alpha1.Kyma, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(kymasResource, c.ns, kyma), &v1alpha1.Kyma{})
...
func (c *FakeKymas) Update(ctx context.Context, kyma *v1alpha1.Kyma, opts v1.UpdateOptions) (result *v1alpha1.Kyma, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(kymasResource, c.ns, kyma), &v1alpha1.Kyma{})
...
func (c *FakeKymas) UpdateStatus(ctx context.Context, kyma *v1alpha1.Kyma, opts v1.UpdateOptions) (*v1alpha1.Kyma, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(kymasResource, "status", c.ns, kyma), &v1alpha1.Kyma{})
...
func (c *FakeKymas) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(kymasResource, c.ns, name, opts), &v1alpha1.Kyma{})
...
func (c *FakeKymas) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(kymasResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.KymaList{})
	return err
}
