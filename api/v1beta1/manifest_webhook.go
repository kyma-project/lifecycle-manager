...
//nolint:lll
//+kubebuilder:webhook:path=/mutate-operator-kyma-project-io-v1beta1-manifest,mutating=true,failurePolicy=fail,sideEffects=None,groups=operator.kyma-project.io,resources=manifests,verbs=create;update,versions=v1beta1,name=v1beta1.mmanifest.kb.io,admissionReviewVersions=v1
...
//nolint:lll
//+kubebuilder:webhook:path=/validate-operator-kyma-project-io-v1beta1-manifest,mutating=false,failurePolicy=fail,sideEffects=None,groups=operator.kyma-project.io,resources=manifests,verbs=create;update,versions=v1beta1,name=v1beta1.vmanifest.kb.io,admissionReviewVersions=v1
