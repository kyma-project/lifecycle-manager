...
func (in *v1beta1.ConditionBuilder) DeepCopyInto(out *v1beta1.ConditionBuilder) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConditionBuilder.
func (in *v1beta1.ConditionBuilder) DeepCopy() *v1beta1.ConditionBuilder {
	if in == nil {
		return nil
	}
	out := new(v1beta1.ConditionBuilder)
	in.DeepCopyInto(out)
	return out
}
