...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StateCheck) DeepCopyInto(out *StateCheck) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StateCheck.
func (in *StateCheck) DeepCopy() *StateCheck {
	if in == nil {
		return nil
	}
	out := new(StateCheck)
