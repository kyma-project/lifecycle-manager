...
// ExtractManifestFrom extracts the applied configuration owned by fieldManager from
// manifest for the specified subresource. Pass an empty string for subresource to extract
// the main resource. Common subresources include "status", "scale", etc.
// manifest must be a unmodified Manifest API object that was retrieved from the Kubernetes API.
// ExtractManifestFrom provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractManifestFrom(manifest *apiv1beta2.Manifest, fieldManager string, subresource string) (*ManifestApplyConfiguration, error) {
	b := &ManifestApplyConfiguration{}
	err := managedfields.ExtractInto(manifest, internal.Parser().Type("com.github.kyma-project.lifecycle-manager.api.v1beta2.Manifest"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(manifest.Name)
	b.WithNamespace(manifest.Namespace)
...
// ExtractManifest extracts the applied configuration owned by fieldManager from
// manifest. If no managedFields are found in manifest for fieldManager, a
// ManifestApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// manifest must be a unmodified Manifest API object that was retrieved from the Kubernetes API.
// ExtractManifest provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractManifest(manifest *apiv1beta2.Manifest, fieldManager string) (*ManifestApplyConfiguration, error) {
	return ExtractManifestFrom(manifest, fieldManager, "")
}

// ExtractManifestStatus extracts the applied configuration owned by fieldManager from
// manifest for the status subresource.
func ExtractManifestStatus(manifest *apiv1beta2.Manifest, fieldManager string) (*ManifestApplyConfiguration, error) {
	return ExtractManifestFrom(manifest, fieldManager, "status")
}
...
func (b *ManifestApplyConfiguration) WithStatus(value shared.Status) *ManifestApplyConfiguration {
	b.Status = &value
	return b
}

// GetKind retrieves the value of the Kind field in the declarative configuration.
func (b *ManifestApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *ManifestApplyConfiguration) GetAPIVersion() *string {
...
func (b *ManifestApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
