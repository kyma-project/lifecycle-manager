...
import (
	"github.com/kyma-project/lifecycle-manager/pkg/client/clientset/versioned/typed/operator.kyma-project.io/v1alpha1"
...
func (c *FakeOperatorV1alpha1) Kymas(namespace string) v1alpha1.KymaInterface {
