...
var annotationsWithCorrectDomain = map[string]string{"skr-domain": "example.domain.com"}
var annotationsWithWrongDomain = map[string]string{"skr-domain": "wrong.domain.com"}
var emptyAnnotations = map[string]string{}

var headerWithSufficientCertificate = map[string][]string{
	security.XFCCHeader: {
...
var headerWithMalformedCertificate = map[string][]string{
	security.XFCCHeader: {
		"Hash=d54ce461112371914142ca640f0ff7edb5b47778e1e97185336b79f4590e2ce4;Cert=\"" +
