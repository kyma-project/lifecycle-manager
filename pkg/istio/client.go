...
func NewVersionedIstioClient(cfg *rest.Config) (*Client, error) {
...
func (c *Client) createVirtualService(ctx context.Context, obj *v1alpha1.Watcher,
...
func (c *Client) UpdateVirtualServiceConfig(ctx context.Context, obj *v1alpha1.Watcher,
) error {
	var err error
...
func (c *Client) RemoveVirtualServiceConfigForCR(ctx context.Context, obj *v1alpha1.Watcher,
) error {
	virtualService, customErr := c.getVirtualService(ctx)
	if customErr != nil {
		return nil
