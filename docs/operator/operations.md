...
| `lifecycle_mgr_kyma_state`               | Gauge Vector   | kyma_name<br/>state<br/>shoot<br/>instance_id                 | Indicates the state of a Kyma CR. The state can be one of the following:<br/>`Error`: This indicates that there is an error blocking the synchronization of the Kyma CR with the SKR cluster. <br/>`Ready`: This indicates that the Kyma CR has been successfully synchronized with the SKR cluster. <br/>`Processing`: This indicates that the Kyma CR is still being synchronized with the SKR cluster. <br/>`Warning`: This indicates that there is some misconfiguration that needs the user interaction blocking the Kyma CR synchronization with the SKR cluster. <br/>`Deleting`: This indicates that the Kyma CR along with its modules are being removed from the SKR cluster. |
| `lifecycle_mgr_module_state`             | Gauge Vector   | module_name<br/>kyma_name<br/>state<br/>shoot<br/>instance_id | Indicates the state of a module added to a Kyma CR. The state can be one of the following:<br/>`Error`: This indicates that there is an error blocking the installation of the module on the SKR cluster. <br/>`Ready`: This indicates that the module is successfully installed in the SKR cluster. <br/>`Processing`: This indicates that the module is still being installed on the SKR cluster. <br/>`Warning`: This indicates that there is some misconfiguration that needs the user interaction blocking the module installation on the SKR cluster. <br/>`Deleting`: This indicates that the module resources are still being removed from the SKR cluster.                     |
| `lifecycle_mgr_mandatory_modules`        | Gauge          |                                                               | Indicates the number of mandatory ModuleTemplate CRs.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `lifecycle_mgr_mandatory_module_state`   | Gauge Vector   | module_name<br/>kyma_name<br/>state                           | Indicates the state of a mandatory module added to a Kyma CR. The state values are also one of the following: `Error`, `Ready`, `Processing`, `Warning` or `Deleting`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `lifecycle_mgr_self_signed_cert_not_renew` | Gauge Vector  | kyma_name                                                     | Indicates that the self-signed Certificate of a Kyma CR is not renewed yet. This metric is just to verify that that the renewal of the certificate is working as expected since we rely on the cert-manager mechanism for the certificate rotation.                                                                                                                                                                                                                                                                                                                                                                                                                                     |
