...
the [resolution of the modules](https://github.com/kyma-project/lifecycle-manager/blob/main/internal/service/manifest/parser/template_to_module.go) in the Kyma CR control loop.
