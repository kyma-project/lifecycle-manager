...
| `Secret`                   | `klm-watcher`                                 | `istio-system` | Stores the current self-signed CA certificate managed by Cert-Manager. This certificate serves as the root of the watcher PKI.           |
