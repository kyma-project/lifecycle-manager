...
| `lifecycle_mgr_gateway_secret_server_cert_close_to_expiry` | Gauge | -                                                             | Indicates whether the server certificate in the `klm-istio-gateway` secret is close to expiry. Set to `1` when within the expiry threshold, `0` otherwise.                                                                                                                                                                                                                                                                                                                                                                                                             |
